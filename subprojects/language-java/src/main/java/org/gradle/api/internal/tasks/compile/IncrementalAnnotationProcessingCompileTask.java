...
class IncrementalAnnotationProcessingCompileTask implements JavaCompiler.CompilationTask {
    ...
    IncrementalAnnotationProcessingCompileTask(JavaCompiler.CompilationTask delegate, List<AnnotationProcessorDeclaration> processorDeclarations, List<File> annotationProcessorPath) {
